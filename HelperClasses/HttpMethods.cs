...
namespace RestApiTester
{
    public class HttpMethods
    {
        public static readonly IEnumerable<HttpMethodViewModel> Default = new HttpMethodViewModel[]
        {
            ...
            new HttpMethodViewModel("PUT", Color.FromRgb(0x50, 0x83, 0xDE), "Creates a resource at the specified URL (in contrast to POST). This may or may not have side effects at different locations: for instance, a parent resource might now contain a reference to the former."),
